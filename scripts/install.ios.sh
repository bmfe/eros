...
function error_exit {
    ...
    echo -e "\033[33m2 -> cannot remove WeexiOSSDK, please check file permissions. \033[0m"
    echo -e "\033[33m3 -> cannot remove Benmu-iOS-Library, please check file permissions. \033[0m"
...
then
    ...
    git clone https://github.com/bmfe/WeexiOSSDK.git -q && \
