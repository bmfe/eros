...
**eros 是基于对 [weex](https://weex-project.io/cn/) 封装，面向前端 vue 写法的解决方案。由于 app 开发的特殊性，eros 则更偏重关心于整个 app 项目。**
...
## Situation
目前 `eros` 已有数十个 app 在开发中和上线的状态，其中有正在开发中的国外应用 **starLife（100+页面）**，也有国内正在开发的**蜂觅（60+ 页面）**，还有**已上线的应用都在 0-50+ 页面不等**，涉及行业分布于资讯，医疗，直播，招商，购物，政府，办公等等。
